...
public class ArregloNCProveedor {
    
    public ArrayList <DetalleNCProveedor> dc; //Arreglo de objetos para la linea de saldas de compra
    
    //Constructor
    public ArregloNCProveedor()
    {
        dc = new ArrayList();
    }
    
    //Agregamos una fila al detalle
    public void agregar(DetalleNCProveedor nuevo)
    {
        dc.add(nuevo);
    }
    
    //Obtenemos una fila del detalle
    public DetalleNCProveedor getFila(int i)
    {
        return dc.get(i);
    }
    
    //Remplazamos la informacion de la linea
    public void update(int i, DetalleNCProveedor act)
    {
        dc.set(i, act);
    }
