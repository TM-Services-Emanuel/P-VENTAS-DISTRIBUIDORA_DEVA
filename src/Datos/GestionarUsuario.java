...
public class GestionarUsuario {
    ...
    public static String getCodigo() {
        String cod = generarCodigos.getCodigo("SELECT MAX(usu_codigo) FROM usuarios");
        return cod;
    }

    public static String addUsuario(Usuario u) {
        String msg;
        StringBuilder sql = new StringBuilder("INSERT INTO usuarios VALUES (");
...
//                u.getIp() + "')");
    ...
    public static String actUsuario(Usuario u) {
        String msg;
        StringBuilder sql = new StringBuilder("UPDATE usuarios SET perfil_per_id='");
    ...
    public static String actPassword(Usuario u) {
        String msg;
        StringBuilder sql = new StringBuilder("UPDATE usuarios SET usu_password='");
    ...
    public static String delUsuario(String cod, String usuario) {
        String msg;
        StringBuilder sql = new StringBuilder("UPDATE usuarios SET usu_indicador='N', usu='"); 
...
//        msg = Operacion.exeOperacion("UPDATE usuario SET usu_indicador='N' WHERE usu_codigo=" + cod + "");
    ...
    public static List listEmpleados() {
        ...
        sql.append("(SELECT usu_codigo FROM usuarios where vendedor.ven_codigo = usuarios.vendedor_ven_codigo)");
