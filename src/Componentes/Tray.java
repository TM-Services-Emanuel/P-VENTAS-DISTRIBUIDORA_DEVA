...
public class Tray {
    ...
    private Image image =new ImageIcon(getClass().getResource("/Iconos/logo.png")).getImage() ;
    private final TrayIcon trayIcon = new TrayIcon(image, "Sistema Integral de Gestión Farmacéutica", popup);
    //para el Timer
    private Timer timer;    
