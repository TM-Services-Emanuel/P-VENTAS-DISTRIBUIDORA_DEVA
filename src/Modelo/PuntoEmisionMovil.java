...
public class PuntoEmisionMovil {
    ...
    //Constructor
    public PuntoEmisionMovil(int idEmision, int idTimbrado, String Establecimiento, String puntoEmision, String direccion, int facturaInicio, int facturaFin, int facturaActual, String Tipo, String Finalidad, String Ip, String Estado) {
    ...
    public PuntoEmisionMovil(int idEmision, String Establecimiento, String puntoEmision, String direccion, int facturaInicio, int facturaFin, int facturaActual, String Tipo, String Finalidad, String Ip, String Estado) {
        this.idEmision = idEmision;
        this.Establecimiento = Establecimiento;
        this.puntoEmision = puntoEmision;
        this.direccion = direccion;
