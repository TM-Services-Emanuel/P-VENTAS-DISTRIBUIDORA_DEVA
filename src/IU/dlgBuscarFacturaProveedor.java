...
public class dlgBuscarFacturaProveedor extends javax.swing.JDialog {

    CabecerasTablas cabe = new CabecerasTablas();

    public dlgBuscarFacturaProveedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        titulo();
        CabecerasTablas.fac_nc_compra(tbDetalle);
        //CabecerasTablas.limpiar_fac_nc_compra(tbDetalle);
        controlNCProveedor.listFacturas("",tbDetalle);
        Renders();
    ...
    private void initComponents() {
        ...
        Blanco.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1, 63, 709, 252));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Blanco, javax.swing.GroupLayout.DEFAULT_SIZE, 316, Short.MAX_VALUE)
        );
    ...
    private void tbDetalleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDetalleMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            controlNCProveedor.selectFactura();
            this.dispose();
        }
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        ...
        if (txtBuscar.getText().length() == 0) {
            ...
            try {
                ...
                CabecerasTablas.limpiar_fac_nc_compra(tbDetalle);
                controlNCProveedor.listFacturas(cod, tbDetalle);
            } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgBuscarFacturaProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            dlgBuscarFacturaProveedor dialog = new dlgBuscarFacturaProveedor(new javax.swing.JFrame(), true);
