...
public final class dlgBuscarArticulo extends javax.swing.JDialog {
    ...
    public dlgBuscarArticulo(java.awt.Frame parent, boolean modal) {
        ...
        CabecerasTablas.tablaArticuloAuxiliarSalida(tbDetalle);
        controlArticuloMovil.filtrarCodBarraActivoCStock(tbDetalle, "");
        Renders();
        txtBuscar.requestFocus();
    }
    
    public static void Renders() {
        tbDetalle.getColumnModel().getColumn(4).setCellRenderer(new RenderDecimalconPuntos());
        tbDetalle.getColumnModel().getColumn(5).setCellRenderer(new RenderDecimal2());
    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(152, 11, 490, 23));
        ...
        Blanco.add(Oscuro, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 678, 70));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(Blanco, javax.swing.GroupLayout.PREFERRED_SIZE, 678, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void tbDetalleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDetalleMouseClicked
        // TODO add your handling code here:
            ...
            double st = Double.parseDouble(tbDetalle.getValueAt(x, 4).toString());
            if(st==0){
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        ...
        if(txtBuscar.getText().length()==0){
            CabecerasTablas.limpiarTablasArtAuxSalida(tbDetalle);
            controlArticuloMovil.filtrarCodBarraActivoCStock(tbDetalle, "");
        }else{
        ...
        try {
            ...
            CabecerasTablas.limpiarTablasArtAuxSalida(tbDetalle);
            controlArticuloMovil.filtrarCodBarraActivoCStock(tbDetalle, cod);
            Renders();
        } catch (Exception e) {
    ...
    private void tbDetalleMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDetalleMouseExited
        // TODO add your handling code here:
    }//GEN-LAST:event_tbDetalleMouseExited
