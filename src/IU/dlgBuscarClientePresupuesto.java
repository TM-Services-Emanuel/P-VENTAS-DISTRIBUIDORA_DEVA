...
public class dlgBuscarClientePresupuesto extends javax.swing.JDialog {
    ...
    public dlgBuscarClientePresupuesto(java.awt.Frame parent, boolean modal) {
        ...
        controlCliente.listClientes(jTable1);
        grupo();
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
      ...
      /*  if(evt.getClickCount()==2)
        {
            controlPresupuesto.selectCliente();
            dlgPresupuestos.btnBusArticulo.setEnabled(true);
            this.dispose();
        }*/
...
//                    controlCliente.filDireccion(jTable1, cod);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgBuscarClientePresupuesto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgBuscarClientePresupuesto dialog = new dlgBuscarClientePresupuesto(new javax.swing.JFrame(), true);
