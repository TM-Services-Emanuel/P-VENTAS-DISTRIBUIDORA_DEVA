 ...
 * @author ADMIN
 */
public class dlgGestSolicitudNCP extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public dlgGestSolicitudNCP(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        String montoFinal = String.valueOf(controlSalida.getTotalDetalleSalidaNCP());
        DecimalFormat df = new DecimalFormat("#,###");
        dlgGestSolicitudNCP.txtTotal.setText(df.format(Integer.parseInt(montoFinal.replace(".", "").replace(",", ""))));
    ...
    private void Seleccionado() {
        if (dlgGestSolicitudNCP.tbSalidas.getRowCount() != 0) {
            for (int i = 0; i < dlgGestSolicitudNCP.tbSalidas.getRowCount(); i++) {
                int f = Integer.parseInt(dlgGestSolicitudNCP.tbSalidas.getValueAt(i, 0).toString());
    ...
    private void Cancelar() {
        ...
        dlgSolicitudNCProveedor.btnActualizar.doClick();
        this.dispose();
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        String cod = GestionarSalida.getCodigoSolicitud();
        txtCod.setText(cod);
        try {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (tbDetalle.getRowCount() == 0) {
            ...
            if (opcion.equals("N")) {
                try {
                    int resp = JOptionPane.showConfirmDialog(this, "¿Seguro que deseas registrar esta Solicitud de Nota de Crédito al sistema?", "CONFIRMACIÓN DE SOLICITUD", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                    if (resp == JOptionPane.YES_OPTION) {
                        try {
                            String usuario = Login.getUsuarioLogueado();
                            prepararBD();
                            con.setAutoCommit(false);
                            String sql = "insert into solicitud_nc_provedor values(" + txtCod.getText() + "," + txtCaja.getText() + "," + txtcodProv.getText() + ",'"
                            ...
                            for (int j = 0; j < fila; j++) {
                                ...
                                sql = "insert into detalle_solicitud values(" + txtCod.getText() + "," + filas[0] + "," + filas[1] + "," + filas[2] + "," + filas[3] + "," + filas[4] + ")";
                            ...
                            for (int j = 0; j < fila2; j++) {
                                ...
                                sql = "insert into ref_solicitud_salida values(" + txtCod.getText() + "," + filas[0] + ")";
                            ...
                            con.commit();
                            stTransaccion.close();
                            Mensajes.informacion("La Solicitud de Nota de Crédito \nN°:" + txtCod.getText() + "\nPara el Proveedor:" + cbProveedor.getSelectedItem() + "\nHa sido regitrada exitosamente");
                        } catch (SQLException e) {
                            try {
                                con.rollback();
                ...
                try {
                    int resp = JOptionPane.showConfirmDialog(this, "¿Seguro que deseas actualizar el estado de esta Solicitud de Nota de Crédito?", "CONFIRMACIÓN DE SOLICITUD", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                    if (resp == JOptionPane.YES_OPTION) {
                        ...
                        String msg = controlSalida.ProcSolicitud(id, proc);
                        if (msg.equals("OK")) {
                            Cancelar();
                        } else {
    ...
    private void btnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarActionPerformed
        ...
        if (cbProveedor.getSelectedIndex() == 0) {
            ...
            try {
                dlgSeleccionarSalidasNC sncp = new dlgSeleccionarSalidasNC(null, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgGestSolicitudNCP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgGestSolicitudNCP dialog = new dlgGestSolicitudNCP(new javax.swing.JFrame(), true);
