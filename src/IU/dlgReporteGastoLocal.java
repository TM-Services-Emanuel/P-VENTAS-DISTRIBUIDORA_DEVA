...
public class dlgReporteGastoLocal extends javax.swing.JDialog {
    ...
    public dlgReporteGastoLocal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        rbGFA.setText("Gastos Local del día (fecha actual):");
        ...
        rbGFF.setText("Gastos Local entre fechas:");
    ...
    private void btnGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarActionPerformed
        ...
        try{
            if (rbGFA.isSelected()) {
            LevantarReporte("\\Reports\\gastos\\gastosLocal.jasper", Date.valueOf(lbFechaActualR.getText().trim()), Date.valueOf(lbFechaActualR.getText().trim()),"L", "LOCAL");
            ...
            if (txtFDesde.getText().trim().isEmpty()) {
                ...
                LevantarReporte("\\Reports\\gastos\\gastosLocal.jasper", Date.valueOf(txtFDesdeR.getText().trim()), Date.valueOf(txtFHastaR.getText().trim()),"L", "LOCAL");
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgReporteGastoLocal dialog = new dlgReporteGastoLocal(new javax.swing.JFrame(), true);
