...
public class dlgReporteComprasRealizadas extends javax.swing.JDialog {
    ...
    public dlgReporteComprasRealizadas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        cbResumen = new rojerusan.RSCheckBox();
        cbDetallado = new rojerusan.RSCheckBox();
        ...
        cbClienteEspecifico.setText("Seleccionar Proveedor especifico");
        ...
        jPanel4.add(cbClienteEspecifico, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 10, 210, 27));
        ...
        jPanel4.add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 10, 26, 27));
        ...
        GrupoReporte.add(cbResumen);
        cbResumen.setForeground(new java.awt.Color(0, 0, 0));
        cbResumen.setSelected(true);
        cbResumen.setText("RESUMIDO");
        cbResumen.setColorCheck(new java.awt.Color(0, 102, 102));
        cbResumen.setColorUnCheck(new java.awt.Color(0, 0, 0));
        cbResumen.setFocusable(false);
        cbResumen.setFont(new java.awt.Font("Roboto", 1, 12)); // NOI18N

        GrupoReporte.add(cbDetallado);
        cbDetallado.setForeground(new java.awt.Color(0, 0, 0));
        cbDetallado.setText("DETALLADO");
        cbDetallado.setColorCheck(new java.awt.Color(0, 102, 102));
        cbDetallado.setColorUnCheck(new java.awt.Color(0, 0, 0));
        cbDetallado.setFocusable(false);
        cbDetallado.setFont(new java.awt.Font("Roboto", 1, 12)); // NOI18N
        ...
        BlancoLayout.setHorizontalGroup(
            ...
            .addGroup(BlancoLayout.createSequentialGroup()
                ...
                .addGroup(BlancoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(BlancoLayout.createSequentialGroup()
                        .addComponent(cbResumen, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cbDetallado, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        BlancoLayout.setVerticalGroup(
            ...
            .addGroup(BlancoLayout.createSequentialGroup()
                ...
                .addGroup(BlancoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cbResumen, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cbDetallado, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Blanco, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        // TODO add your handling code here:
        try {
            dlgBuscarProveedor1 bc = new dlgBuscarProveedor1(null, true);
    ...
    private void btnGenerar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerar1ActionPerformed
        ...
        if (lbSi.getText().equals("NO")) {
            Mensajes.Sistema("Para poder generar el reporte es necesario seleccionar el Proveedor.");
            ...
            if (rpta == 0) {
                if (cbResumen.isSelected()) {
                    VisorReportes vr = new VisorReportes(null, true);
                    try {
                        String jasperUrl3 = System.getProperty("user.dir").concat("\\Reports\\compras\\compras_gral_resumido.jasper");
                        JasperReport report = (JasperReport) JRLoader.loadObjectFromFile(jasperUrl3);
                        //para los parametro
                        Map parametros = new HashMap();
                        parametros.clear();
                        //Nuestro parametro se llama "pLastName"
                        parametros.put("idProv", Integer.parseInt(lbCodCliente.getText().trim()));
                    ...
                    vr.setVisible(true);
                } else if (cbDetallado.isSelected()) {
                    VisorReportes vr = new VisorReportes(null, true);
                    try {
                        String jasperUrl3 = System.getProperty("user.dir").concat("\\Reports\\compras\\compras_gral.jasper");
                        JasperReport report = (JasperReport) JRLoader.loadObjectFromFile(jasperUrl3);
                        //para los parametro
                        Map parametros = new HashMap();
                        parametros.clear();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgReporteComprasRealizadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgReporteComprasRealizadas dialog = new dlgReporteComprasRealizadas(new javax.swing.JFrame(), true);
    ...
    private rojerusan.RSCheckBox cbDetallado;
    private rojerusan.RSCheckBox cbResumen;
