...
public class dlgReporteGastoReparto extends javax.swing.JDialog {
    ...
    public dlgReporteGastoReparto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void prepararBD() {
        {
            try {
                con = (MariaDbConnection) conectar.getConexion();
                if (con == null) {
    ...
    private void initComponents() {
        ...
        rbGFA.setText("Gastos en Reparto/s del día (fecha actual):");
        ...
        rbGFF.setText("Gastos en Reparto/s entre fechas:");
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Blanco, javax.swing.GroupLayout.PREFERRED_SIZE, 252, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void btnGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarActionPerformed
        ...
        try{
            if (rbGFA.isSelected()) {
            LevantarReporte("\\Reports\\gastos\\gastosLocal.jasper", Date.valueOf(lbFechaActualR.getText().trim()), Date.valueOf(lbFechaActualR.getText().trim()),"R", "EN REPARTOS");
            ...
            if (txtFDesde.getText().trim().isEmpty()) {
                ...
                LevantarReporte("\\Reports\\gastos\\gastosLocal.jasper", Date.valueOf(txtFDesdeR.getText().trim()), Date.valueOf(txtFHastaR.getText().trim()),"R", "EN REPARTOS");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgReporteGastoReparto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgReporteGastoReparto dialog = new dlgReporteGastoReparto(new javax.swing.JFrame(), true);
