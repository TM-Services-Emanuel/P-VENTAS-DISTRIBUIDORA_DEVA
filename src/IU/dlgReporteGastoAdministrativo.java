...
public class dlgReporteGastoAdministrativo extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        rbGFA.setText("Gastos Administrativos del día (fecha actual):");
        ...
        rbGFF.setText("Gastos Administrativos entre fechas:");
    ...
    private void btnGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarActionPerformed
        ...
        try{
            if (rbGFA.isSelected()) {
            LevantarReporte("\\Reports\\gastos\\gastosLocal.jasper", Date.valueOf(lbFechaActualR.getText().trim()), Date.valueOf(lbFechaActualR.getText().trim()),"A", "ADMINISTRATIVO");
            ...
            if (txtFDesde.getText().trim().isEmpty()) {
                ...
                LevantarReporte("\\Reports\\gastos\\gastosLocal.jasper", Date.valueOf(txtFDesdeR.getText().trim()), Date.valueOf(txtFHastaR.getText().trim()),"A", "ADMINISTRATIVO");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgReporteGastoAdministrativo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgReporteGastoAdministrativo dialog = new dlgReporteGastoAdministrativo(new javax.swing.JFrame(), true);
