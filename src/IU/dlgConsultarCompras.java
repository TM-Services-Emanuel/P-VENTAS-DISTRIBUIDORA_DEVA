...
public class dlgConsultarCompras extends javax.swing.JDialog {
    ...
    public static void Renders() {
        dlgConsultarCompras.tbCompra.getColumnModel().getColumn(8).setCellRenderer(new RenderDecimal2());
        dlgConsultarCompras.tbCompra.getColumnModel().getColumn(9).setCellRenderer(new RenderDecimal2());
    }

    public static void RendersD() {
        dlgConsultarCompras.tbDetalleCompra.getColumnModel().getColumn(4).setCellRenderer(new RenderDecimalconPuntos());
    ...
    private void btnAnularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnularActionPerformed
        ...
        if (dlgConsultarCompras.tbCompra.getSelectedRow() < 0) {
            ...
            String condicion = dlgConsultarCompras.tbCompra.getValueAt(x, 6).toString();
            String estado = dlgConsultarCompras.tbCompra.getValueAt(x, 11).toString();
            String pago = dlgConsultarCompras.tbCompra.getValueAt(x, 10).toString();
