...
public class dlgConsultarNCCliente extends javax.swing.JDialog {

    CabecerasTablas cabe = new CabecerasTablas();

    public dlgConsultarNCCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        titulo();
        CabecerasTablas.consNCProveedor(tbNC);
        CabecerasTablas.consDetalleCompras(tbDetalleNCP);
        controlNCProveedor.listarNCCliente(tbNC);
        Renders();
        ocultar(0);
    ...
    public static void Renders() {
        dlgConsultarNCCliente.tbNC.getColumnModel().getColumn(9).setCellRenderer(new RenderDecimal2());
    }

    public static void RendersD() {
        dlgConsultarNCCliente.tbDetalleNCP.getColumnModel().getColumn(4).setCellRenderer(new RenderDecimalconPuntos());
        dlgConsultarNCCliente.tbDetalleNCP.getColumnModel().getColumn(5).setCellRenderer(new RenderDecimal1());
        dlgConsultarNCCliente.tbDetalleNCP.getColumnModel().getColumn(6).setCellRenderer(new RenderDecimal2());
    ...
    private void tbNCMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbNCMousePressed
        ...
        try {
            ...
            controlNCProveedor.listarDetalleNCCliente(tbDetalleNCP);
            RendersD();
            ocultar(1);
        } catch (Exception e) {
            Mensajes.error(e.toString());
        ...
        if (dlgConsultarNCCliente.tbNC.getSelectedRow() < 0) {
            ...
            if (estado.equals("ANULADO")) {
                ...
                try {
                    ...
                    if (rpta == 0) {
                        msg = controlNCProveedor.anularNCC();
                        if (msg.equals("OK")) {
    ...
    private void tbNCMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbNCMouseReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_tbNCMouseReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgConsultarNCCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgConsultarNCCliente dialog = new dlgConsultarNCCliente(new javax.swing.JFrame(), true);
