...
public class dlgBuscarArticuloNCCliente extends javax.swing.JDialog {

    ArticuloMovil art;

    public dlgBuscarArticuloNCCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        titulo();
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Iconos/logo1.png")));
        CabecerasTablas.tablaArticuloAuxiliarCompra(tbDetalle);
        controlArticuloMovil.filtrarCodBarraActivo2(tbDetalle, "");
        Renders();
    ...
    public static void Renders() {
        dlgBuscarArticuloNCCliente.tbDetalle.getColumnModel().getColumn(4).setCellRenderer(new RenderDecimal2());
    }
    ...
    private void tbDetalleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDetalleMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            int cerrar = controlNCProveedor.selectArticulo2();
            if (cerrar == 0) {
                this.dispose();
            }
        }
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        ...
        try {
            ...
            //CabecerasTablas.tablaArticuloAuxiliarCompra(tbDetalle);
            CabecerasTablas.limpiarTablasArtAuxCompra(tbDetalle);
            controlArticuloMovil.filtrarCodBarraActivo2(tbDetalle, cod);
            Renders();
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgBuscarArticuloNCCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            dlgBuscarArticuloNCCliente dialog = new dlgBuscarArticuloNCCliente(new javax.swing.JFrame(), true);
