...
public final class dlgEmpresa extends javax.swing.JDialog {
    ...
    public dlgEmpresa(java.awt.Frame parent, boolean modal) {
        ...
        initComponents();
        titulo();
        cargarComboBoxMovil.cargarCiudad(cboCiudad, "SELECT * FROM ciudad WHERE estado='S'");
    ...
    public void modcboCiudad(int codCiu) {
        ...
        try {
            HttpClient ciudad = new HttpClient(new OnHttpRequestComplete() {
                @Override
                public void onComplete(Response status) {
                    if (status.isSuccess()) {
                        try {
                            ...
                            JSONObject jsonCiudad = new JSONObject(status.getResult());
                            for (int f = 0; f < jsonCiudad.length(); f++) {
                                ml.addElement(jsonCiudad.getJSONObject("" + f + "").get("ciudad").toString());
                            }
                            try {
                                try {
                                    URL url = new URL(urlServer() + "getCiudadEspecifico.php?id=" + codCiu);
                                    ...
                                    if (ResponseCod != 200) {
                                        ...
                                        while (scan.hasNext()) {
                                            ciudad.append(scan.nextLine());
                                        }
                                        scan.close();
                                        JSONObject jsonC = new JSONObject(ciudad.toString());
                                        for (int f = 0; f < jsonC.length(); f++) {
                                            Object descripcion = jsonC.getJSONObject("" + f + "").get("ciudad").toString();
            ...
            ciudad.excecute(urlServer() + "getCiudad.php");
        } catch (Exception e) {
            System.out.println("err_modcboCiudad: " + e.getMessage());
        }
    }
    ...
    private void initComponents() {
        ...
        Blanco.add(Oscuro, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 893, 79));
        ...
        Blanco.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(553, 85, -1, -1));
        ...
        Blanco.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 85, -1, -1));

        jScrollPane1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));

        tbEmpresa.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        tbEmpresa.setFont(new java.awt.Font("Roboto", 1, 12)); // NOI18N
        ...
        Blanco.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 268, 893, 176));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (txtNombre.getText().isEmpty()) {
            Mensajes.informacion("Ingrese el Nombre de la Empresa");
            txtNombre.requestFocus();
        } else if (txtRuc.getText().isEmpty()) {
            Mensajes.informacion("Ingrese el RUC de la Empresa");
            txtRuc.requestFocus();
        } else if (txtDireccion.getText().isEmpty()) {
            Mensajes.informacion("Ingrese la Dirección de la Empresa");
            txtDireccion.requestFocus();
        } else if (txtTelefono.getText().isEmpty()) {
            Mensajes.informacion("Ingrese el Número de Telefono de la Empresa");
        ...
        try {
            ...
            if (ResponseCod != 200) {
                ...
                if (jsonIG.length() != 0) {
                    ...
                    frmPrincipal.lbEmpresa.setText(objectIG.getString("razon_social"));
                    frmPrincipal.lbRuc.setText(objectIG.getString("ruc"));
                    frmPrincipal.lbSucursal.setText(objectIG.getString("suc_nombre"));
                } else {
                    frmPrincipal.lbEmpresa.setText("SIN ESPECIFICAR");
                    frmPrincipal.lbRuc.setText("SIN ESPECIFICAR");
                    frmPrincipal.lbSucursal.setText("SIN ESPECIFICAR");
                }
            }
        } catch (IOException | RuntimeException e) {
