...
public class dlgReporteTotalVentas extends javax.swing.JDialog {
    ...
    private void btnGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarActionPerformed
        ...
        if(cbCompleto.isSelected()){
            ...
            jasper.reporteDosParametroHorizontal("\\Reports\\ventas\\DetalleVentasFG.jasper", "desde", Date.valueOf(lbFechaActualR.getText().trim()), "hasta", Date.valueOf(lbFechaActualR.getText().trim()));
            ...
            if(txtFDesde.getText().trim().isEmpty()){
                ...
                jasper.reporteDosParametroHorizontal("\\Reports\\ventas\\DetalleVentasFG.jasper", "desde", Date.valueOf(txtFDesdeR.getText().trim()), "hasta", Date.valueOf(txtFHastaR.getText().trim()));
            }
        }
        }else{
            if (rbRankingA.isSelected()) {
            ...
            if(txtFDesde.getText().trim().isEmpty()){
                ...
                jasper.reporteDosParametroHorizontal("\\Reports\\ventas\\DetalleVentasFR.jasper", "desde", Date.valueOf(txtFDesdeR.getText().trim()), "hasta", Date.valueOf(txtFHastaR.getText().trim()));
            }
        }
